...
#define STRING_CONFIG_H_AUTHOR "Jouni Hartikainen" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Sunhokey i3"
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 125.87
    #define  DEFAULT_bedKi 8.40
    #define  DEFAULT_bedKd 471.74
...
#define THERMAL_RUNAWAY_PROTECTION_HYSTERESIS 35 // in degree Celsius
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 393.8, 160.0}
#define DEFAULT_MAX_FEEDRATE          {100, 100, 5, 50}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {500,500,90,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
